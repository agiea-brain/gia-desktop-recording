...
contextBridge.exposeInMainWorld("electronAPI", {
    ...
    deleteMeeting: (meetingId) =>
        ipcRenderer.invoke("deleteMeeting", meetingId),
    ...
    checkForDetectedMeeting: () =>
        ipcRenderer.invoke("checkForDetectedMeeting"),
    ...
    onOpenMeetingNote: (callback) =>
        ipcRenderer.on("open-meeting-note", (_, meetingId) =>
            callback(meetingId)
        ),
    ...
    onTranscriptUpdated: (callback) =>
        ipcRenderer.on("transcript-updated", (_, meetingId) =>
            callback(meetingId)
        ),
    onSummaryGenerated: (callback) =>
        ipcRenderer.on("summary-generated", (_, meetingId) =>
            callback(meetingId)
        ),
